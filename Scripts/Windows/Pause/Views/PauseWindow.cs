...
namespace Windows.Pause.Views
{
	...
	public class PauseWindow : BaseWindow
	{
		...
		{
			_gameUI.stateChanged += OnGameUIStateChanged;
		}
		...
		public void OpenPauseMenu()
		{
			...
			LevelItem level = _gameManager.GetLevelForCurrentScene();
			if (level == null)
			{
				return;
			}
		...
		protected virtual void Update()
		{
			...
			if (UnityEngine.Input.GetKeyDown(KeyCode.Escape) && _gameUI.state == GameUIState.Paused)
			{
				Unpause();
			}
		}
