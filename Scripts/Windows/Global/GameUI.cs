...
namespace Windows.Global
{
	...
	public class GameUI : MonoBehaviour
	{
		...
		public RadiusVisualizerController radiusVisualizerController
		{
			get
			{
				return FindObjectOfType<RadiusVisualizerController>();
			}
		}
		...
		/// </summary>
		public TowerWindow towerUI
		{
			get
			{
				return FindObjectOfType<TowerWindow>();
			}
		}
		...
		public BuildInfoUI buildInfoUI
		{
			get
			{
				return FindObjectOfType<BuildInfoUI>();
			}
		}
		...
		/// </summary>
		private Camera m_Camera => FindObjectsOfType<Camera>().FirstOrDefault(c => c.name == "GameCamera");
		...
		public void UpgradeSelectedTower()
		{
			...
			bool successfulUpgrade = LevelManager.currency.TryPurchase(upgradeCost);
		...
		public void SellSelectedTower()
		{
			...
			if (LevelManager.currency.CanAfford(sellValue))
			{
				LevelManager.currency.AddCurrency(sellValue);
		...
		public void BuyTower()
		{
			...
			bool successfulPurchase = LevelManager.currency.TryPurchase(cost);
