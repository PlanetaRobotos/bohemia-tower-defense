...
namespace TowerDefense.Targetting.Editor
{
    ...
    public class TargetterEditor : UnityEditor.Editor
    {
	    ...
	    /// </summary>
	    private TargetterCollider m_ColliderConfiguration;
        ...
        /// </summary>
        private float m_ExtraVerticalRange;

        /// <summary>
        ///     The serialized property representing <see cref="m_AttachedCollider" />
        /// </summary>
        private SerializedProperty m_SerializedAttachedCollider;

        /// <summary>
        ///     The targetter to edit
        /// </summary>
        private Targetter m_Targetter;
        ...
        private void OnEnable()
        {
            ...
            else if (m_AttachedCollider is CapsuleCollider) m_ColliderConfiguration = TargetterCollider.Capsule;
        ...
        private void AttachCollider()
        {
            switch (m_ColliderConfiguration)
            {
                case TargetterCollider.Sphere:
                    ...
                    if (m_AttachedCollider != null) DestroyImmediate(m_AttachedCollider, true);
                    m_AttachedCollider = m_Targetter.gameObject.AddComponent<SphereCollider>();
                    m_SerializedAttachedCollider.objectReferenceValue = m_AttachedCollider;
                    break;
                case TargetterCollider.Capsule:
