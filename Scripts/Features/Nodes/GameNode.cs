...
{
	/// <summary>
	///     A point along the path which agents will navigate towards before recieving the next instruction from the
	///     NodeSelector
    ...
    public class GameNode : MonoBehaviour
    {
	    ...
	    /// </summary>
	    [HideInInspector] public AreaMeshCreator areaMesh;
	    ...
	    public GameNode GetNextNode()
        {
            ...
            if (selector != null) return selector.GetNextNode();
            return null;
        }
	    ...
	    protected void OnValidate()
        {
            ...
            if (areaMesh == null) areaMesh = GetComponentInChildren<AreaMeshCreator>();
        }
