...
namespace Features.Economy.Models
{
	/// <summary>
    ...
    public class CurrencyGainer
    {
	    ...
	    public void UpdateGainRate(float currencyGainRate)
        {
            ...
            if (currencyGainRate < 0) throw new ArgumentOutOfRangeException("currencyGainRate");
            if (m_GainTimer == null)
	    ...
	    protected void ConstantGain()
        {
            ...
            if (currencyChanged != null) currencyChanged(info);
        }
    }
}